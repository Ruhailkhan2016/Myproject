...
const int var1 = 20;    // global variable --> we can access this variable (var1) in whole program...
...
int main()
{
        ...
        const int var1 = 10;    //local variable --> we can access this local variable (var1) olny inside of function or block
